...
*/
    ...
    !(function () {
      ...
      var defaultOptions = {
         ...
         */
        dictDefaultMessage: "Drop files atau Klik disini untuk upload dokumen",
                  ...
                  var setupHiddenFileInput = function setupHiddenFileInput() {
                    ...
                    _this2.hiddenFileInput.addEventListener(
                      ...
                      function () {
                        ...
                        if (files.length) {
                          var _iterator = dropzone_createForOfIteratorHelper(
                              files,
                              true
                            ),
                            _step;
              ...
              value: function _getParamName(n) {
                if (typeof this.options.paramName === "function") {
                  ...
                  return ""
                    ...
                    .concat(
                      this.options.uploadMultiple ? "[".concat(n, "]") : ""
                    );
                }
                    ...
                    for (_iterator6.s(); !(_step6 = _iterator6.n()).done; ) {
                      ...
                      if (
                        ...
                        if (entry.isFile) {
                          ...
                          result.push(
                            _this4._addFilesFromDirectory(entry, entry.name)
                          );
                        } else {
                  ...
                  try {
                    for (_iterator15.s(); !(_step15 = _iterator15.n()).done; ) {
                      ...
                      if (
                        ...
                        var _iterator16 = dropzone_createForOfIteratorHelper(
                            input.options,
                            true
                          ),
                          _step16;
