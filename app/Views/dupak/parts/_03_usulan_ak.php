      ...
      <?php foreach ($dupak_detail as $detail) : ?>
        <tr>
          ...
          <td class="text-center ">
            <button class="btn btn-xs btn-info mr-3" title="Detail" data-toggle="modal" data-target="#modal-detail-kegiatan" data-id="<?= $detail->id ?>"><i class="far fa-fw fa-list-alt"></i> Detail</button>

            <?php if (in_groups(['dosen', 'operator'])) : ?>
              <?php if ($dupak->tahap_id == 1 or $dupak->tahap_id == 10 or $dupak->tahap_id == 25 or $dupak->tahap_id == 45) : ?>
                <button class="btn btn-xs btn-outline-danger" title="Detail"><i class="far fa-fw fa-trash-alt"></i> Hapus</button>
              <?php endif ?>
            <?php endif ?>

            <?php if (in_groups('verifikator') and $dupak->tahap_id == 20) : ?>
              <button class="btn btn-xs btn-warning" title="Catatan Evaluasi"><i class="far fa-fw fa-edit"></i> Evaluasi</button>
            <?php endif ?>
