...
<?php if (in_groups('dosen') or in_groups('operator')) : ?>
  <div class="row">
    <div class="col-auto">
      <div class="button-cetak-sp d-flex flex-column">
        <button type="button" class="btn btn-sm btn-outline-info mb-2 text-left" data-toggle="modal" data-target="#modal-cetak-sp" data-id="<?= $dupak->id; ?>"><i class="fas fa-fw fa-print"></i> Cetak Surat Pernyataan</button>
      </div>
    </div>
  </div>
<?php endif ?>
...
<div class="row">
  <div class="col">
    <div class="card card-default card-tabs shadow shadow-none mb-3">
      <div class="card-header p-0 pt-1">
        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">

          <li class="nav-item">
            <a class="nav-link active" id="list-dokumen-tab" data-toggle="pill" href="#list-dokumen" role="tab" aria-controls="list-dokumen" aria-selected="true"><i class="fas fa-fw fa-list-alt"></i> Yang sudah ter-upload</a>
          </li>
