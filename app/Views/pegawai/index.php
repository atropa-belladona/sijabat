      ...
      <tbody>
        ...
        <?php foreach ($pegawai as $sdm) : ?>
          <tr>
            ...
            <td class="align-middle text-left"><?= $sdm->jenjang_pendidikan . ' ' . $sdm->unit_kerja ?></td>
            ...
            <td class="align-middle text-center">
              <a href="<?= route_to('operator_request', $sdm->id_sdm) ?>" class="btn btn-xs btn-warning"><i class="fas fa-fw fa-arrow-right"></i> Usulkan</a>
            </td>
          </tr>
        <?php endforeach ?>
      </tbody>
