...
<div class="surat-pernyataan">
  ...
  <div class="row">
    <div class="col text-center">
      ...
      <div class="font-weight-bold text-md">MELAKSANAKAN PENGABDIAN KEPADA MASYARAKAT</div>
    </div>
  </div>
  ...
  <div class="row mt-4">
    <div class="col text-sm">
      Telah melaksanakan kegiatan pengabdian kepada masyarakat sebagai berikut :
    </div>
  </div>
